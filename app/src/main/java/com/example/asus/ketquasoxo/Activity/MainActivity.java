...
import static com.example.asus.ketquasoxo.VariableStatic.ketQuaXoSo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addViewPager() {
        ...
        for (int i = 0; i < 8; i++) {
            list.add(new XoSoFragment(ketQuaXoSo.get(i).getNgay()));
            nameTab[i] = ketQuaXoSo.get(i).getTenTinh();
        }
    ...
    private void getData() {
        ketQuaXoSo.add(getTinhHCM());
        ketQuaXoSo.add(getTinhCT());
        ketQuaXoSo.add(getTinhCM());
        ketQuaXoSo.add(getTinhBTH());
        ketQuaXoSo.add(getTinhBP());
        ketQuaXoSo.add(getTinhBL());
        ketQuaXoSo.add(getTinhBD());
        ketQuaXoSo.add(getTinhAG());
    }
